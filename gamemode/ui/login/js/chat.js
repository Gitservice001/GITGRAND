let chat =
{
	...
	lang:'en',
	isTyping: false, // Флаг состояния набора текста
	typingTimer: null, // Таймер для отслеживания окончания набора
    testMode: false
};
...
function ChangeVipState(state){
    if(state == true)$('#vipchat').show();
    else $('#vipchat').hide();
}

function ChangeAdminState(state){
    if(state == true)$('#adminchat').show();
    else $('#adminchat').hide();
}
...
var chatAPI =
{
    push: (text,name = '',type = 999,color = '',nonrp = false,additional = 0) =>
    {
        ...
        //
        else if(type == 202)chat.container.prepend(`${text}`);
        //
        else if(type == 300)chat.container.prepend(`<div class="chat-post vip-chat"><strong onclick = "openBuyPrime()">${name}:</strong>${text}</div>`);
        else if(type == 301)chat.container.prepend(`<div class="chat-post vip-activation" onclick = "openBuyPrime()">${text}<img src="images/chat/prime-platinum.svg" /><button>${color}</button></div>`);
        //
...
let api = {"chat:push": chatAPI.push, "chat:clear": chatAPI.clear, "chat:activate": chatAPI.activate, "chat:show": chatAPI.show, "chat:clearVipMessages": chatAPI.clearVipMessages, "chat:setTestMode": chatAPI.setTestMode};
for(let fn in api)
{
        ...
        if (event.which == 84 && chat.input == null
            ...
            if (value.length > 0 && new Date().getTime() - lastMessage > 500) {
                ...
                if (value.trim()[0] == "/") {
                    ...
                    if (value.length <= 100 || chat.testMode){
                        let sendcheck = 0;
                        ...
                        else if($('.connect-radio')[10].checked == true)sendcheck = 14;
                        //famchat
            ...
            if($('.connect-radio')[0].checked == true){
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[1].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[1].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[2].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[2].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[3].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[3].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[4].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[4].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[5].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[5].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[6].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[6].checked = false,$('.connect-radio')[10].checked = true;
                ...
                else if($("#vipchat" ).is(':visible'))$('.connect-radio')[7].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[7].checked = false,$('.connect-radio')[10].checked = true;
                else $('.connect-radio')[7].checked = false,$('.connect-radio')[0].checked = true;
            }
            else if($('.connect-radio')[8].checked == true){
                if($("#vipchat" ).is(':visible'))$('.connect-radio')[8].checked = false,$('.connect-radio')[9].checked = true;
                else if($("#adminchat" ).is(':visible'))$('.connect-radio')[8].checked = false,$('.connect-radio')[10].checked = true;
                else $('.connect-radio')[8].checked = false,$('.connect-radio')[0].checked = true;
            }
            else if($('.connect-radio')[9].checked == true){
                if($("#adminchat" ).is(':visible'))$('.connect-radio')[9].checked = false,$('.connect-radio')[10].checked = true;
                else $('.connect-radio')[9].checked = false,$('.connect-radio')[0].checked = true;
            }
